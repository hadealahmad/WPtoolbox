	...
	<item>
		...
		<wp:postmeta>
			...
			<wp:meta_value><![CDATA[1000${index}]]></wp:meta_value>
                        ...
                        // We also need to add the attachment item for the featured image to work well in some importers
                        // But for simplicity in demo content, we just set the meta key.
                    }
                }
            });
